...
switch(state)
{
	case "idle":
	{
		velh = 0;
		timer_state++;
		if(sprite_index != spr_spectre_idle)
		{
			//reiniciar a animacao de hit
			image_index = 0;
		}
		sprite_index = spr_spectre_idle;
	...
	{
		timer_state++;
		if(sprite_index != spr_spectre_walk)
		{
			image_index = 0;
			velh = choose(1, -1);
		}
		
		sprite_index = spr_spectre_walk;
	...
	{
		velh = 0;
		if(sprite_index != spr_spectre_scare)
		{
			image_index = 0;
			posso = true;
		}
		sprite_index = spr_spectre_scare;
	...
	case "hit":
	{
		if(sprite_index != spr_spectre_death)
		{
			//reiniciar a animacao de hit
			image_index = 0;
		}
		sprite_index = spr_spectre_death;
		velh = 0;
